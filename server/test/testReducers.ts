...
describe('Reducers Test', () => {
  ...
  it('minCamaxOfSuitrd reducer', () => {
    const maxOfSuit = cards.reduce(maxCardOfSuit([Suit.HEARTS]))
  ...
  it('getSuitWithFewestCardsButNotZero reducer', () => {
    const suitWithFewest = getSuitWithFewestCardsButNotZero(cards)
